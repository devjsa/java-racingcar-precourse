package com.wooahan.constants;

public class MessageConstants {
    public static final String GREETING_MESSAGE = "***자동차 경주를 시작합니다.***\n자동차는 10대, 경주 횟수는 20회까지 가능합니다.";
    public static final String CAR_NAME_REQUIRE_MESSAGE = "경주할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분";
